# Bentala & Aruna
Pilot project for writing sequential story, logged, and well documented. A swordwoman, a jester-knight, and 3 weeks to learn love (and throwing swords).
...
## Quick Start (untuk kolaborator/future me)

```bash
# Clone
git clone https://github.com/rwxreadreadwrite/bentaladanaruna.git

# Branch baru untuk chapter
git checkout -b draft/[nama]/ch[XX]

# Commit per scene
git add .
git commit -m "feat(ch02): scene 1 - Jester vs Knight debate"
